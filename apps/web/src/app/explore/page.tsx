...
interface InstitutionItem {
  name: string;
  type: string;
  category: 'HIGHER_ED' | 'GRAMMAR' | 'ACADEMY' | 'INDEPENDENT' | 'COMPREHENSIVE';
  city: string;
    ...
    <div style={{ minHeight: '100vh', backgroundColor: 'var(--bg-canvas)' }}>
      <div style={{ padding: '40px 24px', maxWidth: '1200px', margin: '0 auto', width: '100%' }}>
        ...
        <div style={{ marginBottom: '32px' }}>
          ...
          <p style={{ fontSize: '1.05rem', color: 'var(--text-secondary)', marginTop: '8px', maxWidth: '820px' }}>
            Explore verified educational institutions across the UK, USA, Canada, Australia, and New Zealand. Research premier UK State Grammar Schools (11+), top Academies & Sixth Forms, world-renowned Independent Schools, and Russell Group research universities.
          </p>
          ...
          <div style={{ display: 'flex', gap: '8px', marginTop: '12px', flexWrap: 'wrap', alignItems: 'center' }}>
            ...
            {[
              ...
              { label: '🌟 Academies & Sixth Forms', value: 'ACADEMY' },
              { label: '🏰 Independent / Public Schools', value: 'INDEPENDENT' },
              { label: '🎓 Universities & Colleges', value: 'HIGHER_ED' },
            ].map((cat) => (
              <button
                key={cat.value}
