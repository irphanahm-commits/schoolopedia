...
export const INDIAN_MARATHON_REGISTRY: IndianMarathonVideo[] = [
  ...
  {
    id: 'c10m_nexttoppers_realnumbers',
    ...
    type: 'ONE_SHOT_CHAPTER',
    boardAlignment: 'NCERT Chapter 1 / CBSE Class 10',
    educator: 'Shobhit Nirwan (Next Toppers)',
    gradeSlug: 'grade-10',
    subjectSlug: 'mathematics',
    summary: 'Fundamental Theorem of Arithmetic, irrational proofs (√2, √3, √5), and HCF/LCM application word problems.',
  },
  {
    id: 'c10m_nexttoppers_linear',
    ...
    language: 'Hindi & Hinglish',
    type: 'ONE_SHOT_CHAPTER',
    boardAlignment: 'NCERT Chapter 3 / CBSE Class 10',
    educator: 'Shobhit Nirwan (Next Toppers)',
    gradeSlug: 'grade-10',
    subjectSlug: 'mathematics',
    summary: 'Substitution, elimination, and unique tricks to solve upstream/downstream and age word problems without confusion.',
  },
  {
    id: 'c10m_nexttoppers_quadratic',
    ...
    gradeSlug: 'grade-10',
    subjectSlug: 'mathematics',
    summary: 'Discriminant conditions, roots formulation, and Sridharacharya formula applied to board exam PYQs.',
  },
  ...
  // ===========================================================================
  {
    ...
    educator: 'Prashant Kirad (Next Toppers)',
    gradeSlug: 'grade-10',
    subjectSlug: 'science',
    summary: 'Signature engaging explanation of chemical reactions, balancing equations, redox reactions, and board exam tips.',
  },
  {
    id: 'c10s_nexttoppers_light',
    ...
    gradeSlug: 'grade-10',
    subjectSlug: 'science',
    summary: 'Complete ray diagrams for concave and convex mirrors, lens formula, power of lens, and sign convention tips.',
  },
  {
    id: 'c10s_nexttoppers_electricity',
    ...
    gradeSlug: 'grade-10',
    subjectSlug: 'science',
    summary: 'Ohm’s law, factors affecting resistance, series vs parallel circuits, and heating effect numericals.',
  },
  {
    id: 'c10s_nexttoppers_expected',
    ...
    language: 'Hindi & Hinglish',
    type: 'FULL_SYLLABUS_MARATHON',
    boardAlignment: 'CBSE Class 10 Board Exam Practice',
    educator: 'Prashant Kirad (Next Toppers)',
    gradeSlug: 'grade-10',
    subjectSlug: 'science',
    summary: 'High-probability board questions selected from previous 5 years papers across Physics, Chemistry, and Biology.',
  },
  {
    id: 'c10sst_nexttoppers_expected',
    title: 'SST Class 10th - 25 Most Expected Questions | Next Toppers',
    channelTitle: 'Next Toppers',
    youtubeVideoId: 'cAkAr2bhCoI',
    durationFormatted: '1h 40m',
    durationSeconds: 6000,
    language: 'Hindi & Hinglish',
    type: 'FULL_SYLLABUS_MARATHON',
    boardAlignment: 'CBSE Class 10 Social Science Board Exam',
    educator: 'Next Toppers Faculty',
    gradeSlug: 'grade-10',
    subjectSlug: 'social-studies',
    summary: '25 most anticipated questions covering History (Nationalism), Geography (Resources), Civics (Power Sharing), and Economics.',
  },
  {
